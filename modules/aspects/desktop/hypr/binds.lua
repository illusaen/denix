...
hl.bind(
  "SUPER + CTRL + SHIFT + Q",
  hl.dsp.exec_cmd("pkill -9 winedevice.exe"),
  { description = "Kill Wine", repeating = false }
)
hl.bind("SUPER + G", hl.dsp.exec_cmd("google-chrome"), { description = "Google Chrome" })
...
hl.bind("SUPER + C", hl.dsp.workspace.toggle_special("chat"), { description = "Toggle Chat Workspace" })
...
hl.bind("SUPER + ALT + Left", hl.dsp.layout("fit tobeg"), { description = "Expand to Beg" })
...
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("dms ipc call audio mute"), { description = "Mute", locked = true })
